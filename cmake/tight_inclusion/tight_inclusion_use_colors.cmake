...
if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
  ...
  set(TIGHT_INCLUSION_GLOBAL_FLAGS
      -fdiagnostics-color=always # GCC
      -fcolor-diagnostics # Clang
  )
  tight_inclusion_filter_flags(TIGHT_INCLUSION_GLOBAL_FLAGS)
  message(STATUS "Adding global flags: ${TIGHT_INCLUSION_GLOBAL_FLAGS}")
  add_compile_options(${TIGHT_INCLUSION_GLOBAL_FLAGS})
endif()
